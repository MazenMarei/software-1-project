...
<body>
    ...
    <main class="artist-content">
        <?php $pageTitle = "Artist Followers";
        require_once VIEWS . "components/artist_header.php"; ?>

        <?php require_once VIEWS . 'components/error_display.php'; ?>

        <!-- Followers Table -->
        <h3>Total Followers: <?php echo $totalFollowers; ?></h3>

        <div class="table-container">
            <div class="table-header">
                <h2 class="table-title">All Followers</h2>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/uploads/profiles/<?php echo $follower->getProfilePic(); ?>" alt="Customer Avatar" class="small-avatar me-3" />
                                            <div>
                                                <div class="fw-bold"><?= htmlspecialchars($follower->getFirstName() . ' ' . $follower->getLastName()) ?></div>
                                                <small class="text-muted"><?= htmlspecialchars($follower->getUsername()) ?></small>
                                            </div>
                                        </div>
                                    </td>

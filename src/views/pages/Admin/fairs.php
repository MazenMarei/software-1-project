            ...
            <div class="card-body">
                <form id="artworkFilterForm">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            <label for="categoryFilter" class="form-label">Governments</label>
                        ...
                        <?php else: ?>
                            <?php foreach ($fairs as $fair): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="my-3">
                                            <?php echo htmlspecialchars($fair->getName()); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="my-3">
                                            <?php echo (explode(',', $fair->getLocation())[1]); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="my-3">
                                            <?php echo (explode(',', $fair->getLocation())[0]); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="my-3">
